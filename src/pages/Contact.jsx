...
function Contact() {
    ...
    return (
        <div className='flex gap-10 p-5 md:p-20 justify-around items-center w-screen h-screen'>
            <form className="space-y-2 p-5 md:p-10 2xl:p-20 w-full max-h-full rounded-lg border border-black shadow-md overflow-x-auto overflow-y-auto scrollbar-thin scrollbar-thumb-black scrollbar-track-transparent scrollbar-thumb-rounded-lg scrollbar-track-rounded-full" onSubmit={handleSubmit}>
