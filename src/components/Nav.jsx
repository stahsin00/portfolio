...
function Nav() {
    return (
        <nav className='fixed p-5 space-x-5'>
            <Link to='/portfolio/about'><button className='bg-black hover:bg-teal-700 text-white text-lg font-bold py-2 px-4 pl-6 pr-6 rounded-full border-2 border-white border-solid'>About</button></Link>
