...
function Chat() {
    ...
    return (
        <>
            ...
            {
                isOpen ?
                <div className='bg-white fixed top-0 left-0 md:top-auto md:left-auto md:bottom-5 md:right-20 space-y-5 md:rounded-lg border border-black shadow-md w-screen h-screen md:w-120 md:h-4/6'>
